    ...
    for (LogInfo logInfo : logInfos) {
      ...
      switch (JustlendTrackerTrigger.HexTopicEnum.getBySignHash(topics.get(0))) {
        case TRANSFER:
          ...
          addAssetStatusPojo(result, fromAddress, tokenAddress, TRC20Utils.getTRC20Balance(fromAddress, tokenAddress, blockCapsule), null, null);
          addAssetStatusPojo(result, toAddress, tokenAddress, TRC20Utils.getTRC20Balance(toAddress, tokenAddress, blockCapsule), null, null);
          break;
        case BORROW:
          ...
          addAssetStatusPojo(result, borrower, tokenAddress, null, accountBorrows, totalBorrows);
          break;
        case REPAY_BORROW:
          ...
          addAssetStatusPojo(result, borrowerAddress, tokenAddress, null, accountTotalBorrows, marketTotalBorrows);
          break;
      }
    }
